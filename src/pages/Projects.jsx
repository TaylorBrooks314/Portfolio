  ...
  return (
    <div className='projects'>
      ...
      <div className='recipeDiv'>
        ...
        <p>Food Finder is a simple application that uses a third party recipe API. The user is able to search for recipes based on food item, cuisine, dietary restrictions and the type of meal.
        </p>
